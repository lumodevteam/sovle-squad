...
func map_slots(starting_index: int, pos: Vector2) -> int:
	SnapManager.slot_mapping[$Area2D1.global_position + pos] = starting_index
	SnapManager.slot_mapping[$Area2D2.global_position + pos] = starting_index + 1
	SnapManager.slot_mapping[$Area2D3.global_position + pos] = starting_index + 2
	SnapManager.slot_mapping[$Area2D4.global_position + pos] = starting_index + 3
